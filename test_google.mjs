...
const DB = {
  ...
  async run(){return{};},
  async first(){const s=this.sql; if(s.includes('FROM config')){const c=tbl.config.get('1');return{fallback_ip:c.fallback_ip,ech:c.ech};} if(s.includes('FROM ech_cache')){return{ech:'',ts:0};} if(s.includes('FROM rules'))return null; return null;},
